...
data class PhoneNumberRecord(
    ...
    val number: String = "",
    val operator: String = "",
    val expireDate: String = LocalDate.now().plusMonths(1).toString(),
    val note: String = "",
    val balance: String = "",
    val eid: String = "",
    val smdp: String = "",
    ...
    val signalStatus: String = "在线",
    // SimHub compatibility fields
    val tags: String = "",
    val transactionNotes: String = "",
    val customPrompt: String = "",
    val websiteURL: String = "",
    val cyclePaymentMinorUnits: Int = 0,
    val currencyCode: String = "",
    val cardBackgroundAssetName: String = "",
